...
#define JS_REGISTER_DECL_SINGLE static void RegisterJS(const v8::Handle<v8::Object>& obj)
#define JS_REGISTER_IMPL_SINGLE(type, body) void type::RegisterJS(const v8::Handle<v8::Object>& obj) body

#define JS_REGISTER_DECL_TMPL static void RegisterJS(const v8::Handle<v8::ObjectTemplate>& obj)
#define JS_REGISTER_IMPL_TMPL(type, body) void type::RegisterJS(const v8::Handle<v8::ObjectTemplate>& obj) body
